      ...
      <Container>
        <Flex sx={styles.flex}>
          <Box sx={styles.content}>
            <Text as="span">Behind our technology...</Text>
            <Heading as="h3">Fxbot360 Stack & technologies</Heading>
            <Text as="p">
              Get your best automated trading Bot delivered to you on Mt4 and
              Mt5 trading technologies
            </Text>
